...
# Password: CIS215php!
    ...
    if (validate() == "") {
        print ("<div class='thanks'>Thanks for your submission!</div>");
        print ("<div><a href='project2data.php'>View data page here</a></div>");
        add_data();
    } else {
        print ("<div>We could not take your data at this time</div>");
        print (validate());
        print ("<div><a href='project2survey.php'>Try submitting again here</a></div>");
    }
